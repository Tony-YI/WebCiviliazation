function init_help()
{
	document.getElementById('help').innerHTML='<p><h2>Hint</h2><p><p>Use key "i" to invoke/hide information board<p><p>Use key "m" to invoke/hide small map<p><p>Use key "q" to quit game</p>'
}
